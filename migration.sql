...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'DriverID', N'Address', N'BackgroundCheckDate', N'BackgroundCheckExpiry', N'City', N'CreatedBy', N'CreatedDate', N'DriverEmail', N'DriverName', N'DriverPhone', N'DriversLicenseType', N'DrugTestDate', N'DrugTestExpiry', N'EmergencyContactName', N'EmergencyContactPhone', N'Endorsements', N'FirstName', N'HireDate', N'LastName', N'LicenseClass', N'LicenseExpiryDate', N'LicenseIssueDate', N'LicenseNumber', N'MedicalRestrictions', N'Notes', N'PhysicalExamDate', N'PhysicalExamExpiry', N'State', N'Status', N'TrainingComplete', N'UpdatedBy', N'UpdatedDate', N'Zip') AND [object_id] = OBJECT_ID(N'[Drivers]'))
        SET IDENTITY_INSERT [Drivers] ON;
    EXEC(N'INSERT INTO [Drivers] ([DriverID], [Address], [BackgroundCheckDate], [BackgroundCheckExpiry], [City], [CreatedBy], [CreatedDate], [DriverEmail], [DriverName], [DriverPhone], [DriversLicenseType], [DrugTestDate], [DrugTestExpiry], [EmergencyContactName], [EmergencyContactPhone], [Endorsements], [FirstName], [HireDate], [LastName], [LicenseClass], [LicenseExpiryDate], [LicenseIssueDate], [LicenseNumber], [MedicalRestrictions], [Notes], [PhysicalExamDate], [PhysicalExamExpiry], [State], [Status], [TrainingComplete], [UpdatedBy], [UpdatedDate], [Zip])
    VALUES (1, NULL, NULL, NULL, NULL, NULL, ''2025-01-01T00:00:00.0000000Z'', N''john.smith@school.edu'', N''John Smith'', N''555-0123'', N''CDL'', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, N''Active'', CAST(1 AS bit), NULL, NULL, NULL),
    (2, NULL, NULL, NULL, NULL, NULL, ''2025-01-01T00:00:00.0000000Z'', N''mary.johnson@school.edu'', N''Mary Johnson'', N''555-0456'', N''CDL'', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, N''Active'', CAST(1 AS bit), NULL, NULL, NULL)');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'DriverID', N'Address', N'BackgroundCheckDate', N'BackgroundCheckExpiry', N'City', N'CreatedBy', N'CreatedDate', N'DriverEmail', N'DriverName', N'DriverPhone', N'DriversLicenseType', N'DrugTestDate', N'DrugTestExpiry', N'EmergencyContactName', N'EmergencyContactPhone', N'Endorsements', N'FirstName', N'HireDate', N'LastName', N'LicenseClass', N'LicenseExpiryDate', N'LicenseIssueDate', N'LicenseNumber', N'MedicalRestrictions', N'Notes', N'PhysicalExamDate', N'PhysicalExamExpiry', N'State', N'Status', N'TrainingComplete', N'UpdatedBy', N'UpdatedDate', N'Zip') AND [object_id] = OBJECT_ID(N'[Drivers]'))
