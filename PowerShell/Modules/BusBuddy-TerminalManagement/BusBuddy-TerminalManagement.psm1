...
$testScript | Out-File -FilePath "$env:USERPROFILE\Desktop\BusBuddy-TerminalPersistence-Test.ps1" -Encoding UTF8
...
Write-Information "  Test Script: $env:USERPROFILE\Desktop\BusBuddy-TerminalPersistence-Test.ps1" -InformationAction Continue

Write-Information "🎯 To test terminal persistence features, run: & '$env:USERPROFILE\Desktop\BusBuddy-TerminalPersistence-Test.ps1'" -InformationAction Continue
