...
if (Test-Path $PSScriptAnalyzerSettingsPath) {
    ...
    try {
        ...
        # Settings are applied via -Settings parameter in Invoke-ScriptAnalyzer
        Write-Verbose "PSScriptAnalyzer module imported, settings available at: $PSScriptAnalyzerSettingsPath"
    } catch {
