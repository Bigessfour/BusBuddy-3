...
# Replace Write-Host -> Write-Information inside module functions
Write-Information "Updating dependency graph for $ProjectName" -InformationAction Continue

# ...ensure Export-ModuleMember declarations remain unchanged...
