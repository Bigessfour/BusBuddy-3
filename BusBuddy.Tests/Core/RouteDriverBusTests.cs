    ...
    public class RouteDriverBusTests
    {
        ...
        public async Task Routes_Create_And_Assign_AM_PM_Driver_And_Bus()
        {
            ...
            using (var seed = new BusBuddyDbContext(options))
            {
                ...
                var amBus = new BusBuddy.Core.Domain.Bus { BusNumber = "AM-1", Year = 2021, Make = "IC", Model = "CE", SeatingCapacity = 50, VINNumber = "1HGBH41JXMN109187", LicenseNumber = "AM1" };
                var pmBus = new BusBuddy.Core.Domain.Bus { BusNumber = "PM-1", Year = 2022, Make = "Thomas", Model = "C2", SeatingCapacity = 52, VINNumber = "1HGBH41JXMN109188", LicenseNumber = "PM1" };
