      ...
      `;
            ...
            ps.on("close", (code) => {
                if (code === 0) {
                    ...
                    reject(
                        new Error(
                            `PowerShell command failed: ${stderr || stdout}`,
                        ),
                    );
                }
            });
...
class Grok4MCPServer extends BusBuddyMCPServer {
    ...
    validateConfiguration() {
        ...
        if (!apiKey) {
            console.warn(
                "⚠️  XAI_API_KEY not set. Grok-4 tools will be unavailable.",
            );
    ...
    setupErrorHandling() {
        this.server.onerror = (error) =>
            console.error("[Grok-4 MCP Error]", error);
        ...
        this.server.setRequestHandler(ListToolsRequestSchema, async () => ({
            tools: [
                // Core BusBuddy tools (inherited)
                {
                    name: "bb-health",
                    description:
                        "Run BusBuddy health check to verify system status",
                    inputSchema: {
                        type: "object",
                        properties: {},
                    },
                ...
                // Grok-4 Enhanced Tools
                {
                    ...
                    description:
                        "Analyze BusBuddy code/build issues using Grok-4's advanced reasoning capabilities",
                    inputSchema: {
                        type: "object",
                        properties: {
                            query: {
                                type: "string",
                                description:
                                    "Problem description or error message to analyze",
                            },
                            context: {
                                type: "string",
                                description:
                                    "Additional context (file paths, build logs, etc.)",
                                default: "",
                            },
                            mode: {
                                type: "string",
                                description:
                                    "Response mode: 'quick' (1-2 actionable items) or 'expert' (detailed analysis)",
                                enum: ["quick", "expert"],
                                default: "expert",
                            },
                            includeProjectStatus: {
                                type: "boolean",
                                description:
                                    "Include current BusBuddy project status in analysis",
                                default: true,
                            },
                        },
                        required: ["query"],
                ...
                },
                {
                    ...
                    description:
                        "Get Grok-4 code review and optimization suggestions for BusBuddy components",
                    inputSchema: {
                        type: "object",
                        properties: {
                            filePath: {
                                type: "string",
                                description:
                                    "Path to C# file relative to project root",
                            },
                            mode: {
                                type: "string",
                                description:
                                    "Response mode: 'quick' (1-2 improvements) or 'expert' (detailed review)",
                                enum: ["quick", "expert"],
                                default: "expert",
                            },
                            focusArea: {
                                type: "string",
                                description:
                                    "Specific area to focus on (performance, security, MVVM, Syncfusion, etc.)",
                                default: "general",
                            },
                        },
                        required: ["filePath"],
                ...
                },
                {
                    ...
                    description:
                        "Get Grok-4 guidance on Syncfusion WPF implementation and best practices",
                    inputSchema: {
                        type: "object",
                        properties: {
                            component: {
                                type: "string",
                                description:
                                    "Syncfusion component name (SfDataGrid, DockingManager, etc.)",
                            },
                            issue: {
                                type: "string",
                                description:
                                    "Specific issue or question about the component",
                            },
                            mode: {
                                type: "string",
                                description:
                                    "Response mode: 'quick' (1-2 actionable fixes) or 'expert' (comprehensive guidance)",
                                enum: ["quick", "expert"],
                                default: "expert",
                            },
                            xamlSnippet: {
                                type: "string",
                                description:
                                    "XAML code snippet for analysis (optional)",
                                default: "",
                            },
                        },
                ...
                },
                {
                    ...
                    description:
                        "Get Grok-4 suggestions for Azure SQL query optimization and database design",
                    inputSchema: {
                        type: "object",
                        properties: {
                            query: {
                                type: "string",
                                description:
                                    "SQL query to analyze and optimize",
                            },
                            context: {
                                type: "string",
                                description:
                                    "Context about the query purpose and performance issues",
                                default: "",
                            },
                            mode: {
                                type: "string",
                                description:
                                    "Response mode: 'quick' (1-2 optimizations) or 'expert' (comprehensive analysis)",
                                enum: ["quick", "expert"],
                                default: "expert",
                            },
                        },
                ...
                },
                {
                    ...
                    description:
                        "Get Grok-4 architectural analysis and recommendations for BusBuddy",
                    inputSchema: {
                        type: "object",
                        properties: {
                            component: {
                                type: "string",
                                description:
                                    "Component or module to analyze (Core, WPF, Services, etc.)",
                                default: "overall",
                            },
                            concern: {
                                type: "string",
                                description:
                                    "Specific architectural concern (scalability, maintainability, performance, etc.)",
                                default: "general",
                            },
                            mode: {
                                type: "string",
                                description:
                                    "Response mode: 'quick' (1-2 key recommendations) or 'expert' (comprehensive analysis)",
                                enum: ["quick", "expert"],
                                default: "expert",
                            },
                        },
                ...
                try {
                    switch (name) {
                        ...
                        case "bb-build":
                            ...
                            return await this.runPowerShellCommand(
                                `bb-build --configuration ${config}`,
                            );
                        ...
                        case "grok-analyze-problem":
                            return await this.analyzeWithGrok(
                                args.query,
                                args.context,
                                args.includeProjectStatus,
                                args.mode,
                            );

                        case "grok-code-review":
                            return await this.reviewCodeWithGrok(
                                args.filePath,
                                args.focusArea,
                                args.mode,
                            );
                        ...
                        case "grok-syncfusion-guidance":
                            return await this.getSyncfusionGuidance(
                                args.component,
                                args.issue,
                                args.xamlSnippet,
                                args.mode,
                        ...
                        case "grok-azure-sql-optimize":
                            return await this.optimizeSqlWithGrok(
                                args.query,
                                args.context,
                                args.mode,
                            );
                        ...
                        case "grok-architecture-review":
                            return await this.reviewArchitectureWithGrok(
                                args.component,
                                args.concern,
                                args.mode,
                            );
    ...
    async analyzeWithGrok(
        ...
        if (includeProjectStatus) {
            try {
                ...
                const statusResult =
                    await this.runPowerShellCommand("bb-health");
...
`;
    ...
    async reviewArchitectureWithGrok(
        component = "overall",
        concern = "general",
        mode = "expert",
    ) {
